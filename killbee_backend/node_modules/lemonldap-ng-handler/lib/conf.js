  ...
  HandlerConf = (function() {
    class HandlerConf {
      ...
      constructor(args = {}) {
        ...
        Logger = require('lemonldap-ng-logger');
      ...
      reload() {
        ...
        return this.lmConf.getConf({
          ...
          var a, cond, e, h, headers, j, k, l, len, len1, len2, len3, m, n, name, o, prot, ref, ref1, ref2, ref3, ref4, ref5, ref6, rule, rules, sessionStorageModule, smod, sub, t, type, url, v, vConf, val, vhost, vhostList, w;
          ...
          for (n = 0, len2 = ref4.length; n < len2; n++) {
            type = ref4[n];
            sessionStorageModule = conf[`${type}Storage`].replace(/^Lemonldap::NG::Common::Apache::Session::REST/, 'rest').replace(/^Apache::Session::(?:Browseable::)?/, '');
          ...
          for (vhost in ref6) {
            ...
            if (v.aliases) {
              ...
              t = v.aliases.split(/\s+/);
              for (o = 0, len3 = t.length; o < len3; o++) {
                a = t[o];
